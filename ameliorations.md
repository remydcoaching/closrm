...
## T-024 — Follow Ads Classification

### A-024-01 · Followers comme prospects (vision ManyChat-like) ⭐ VISION PROJET MAJEURE
**Priorité :** Haute (V2)
**Contexte :** Identifié pendant T-024. Demande explicite du fondateur — direction stratégique du produit.
...
**Proposition :** Créer une nouvelle tâche dédiée (T-???) qui couvre : détection followers, création leads, intégration au moteur d'automations existant (T-014), attribution heuristique.

### A-024-02 · Seuils de santé configurables par le coach
**Priorité :** Basse
**Contexte :** Identifié pendant T-024 (config UI)
...
### A-024-03 · Attribution followers → campagnes Follow Ads
**Priorité :** Moyenne (V2)
**Contexte :** Identifié pendant T-024 (croissance Instagram)
...
### A-024-04 · Différencier `reach` et `impressions` dans Follow Ads
**Priorité :** Basse
**Contexte :** Identifié pendant T-024 (KPI Follow Ads)
...
### A-024-05 · Performance Insights IA (recommandations auto)
**Priorité :** Basse (V2)
**Contexte :** Identifié pendant le brainstorming T-024 (couche 3 reportée)
