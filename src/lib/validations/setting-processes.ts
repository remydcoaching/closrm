...
const settingProcessStepCategory = z.enum(['premier_contact', 'relance_en_retard', 'jamais_recontacte', 'any'])
...
export const createSettingProcessStepSchema = z.object({
  ...
  applies_to_category: settingProcessStepCategory.optional(),
})
...
export const updateSettingProcessStepSchema = z.object({
  ...
  applies_to_category: settingProcessStepCategory.nullable().optional(),
})
...
export const reorderSettingProcessStepsSchema = z.array(
  z.object({
...
export type ReorderSettingProcessStepsData = z.infer<typeof reorderSettingProcessStepsSchema>
